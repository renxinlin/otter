...
/**
 * dump记录输出到指定select的日志文件中
 * row_select.log
 *
 * 格式如下
 * ****************************************************
 * * Batch Id: [40] ,total : [16] , normal : [0] , filter :[16] , Time : 2020-12-09 09:53:51:536
 * * Start : [mysql-bin.002760:600996138:1607435221000(2020-12-08 21:47:01)]
 * * End : [mysql-bin.002760:602797989:1607435273000(2020-12-08 21:47:53)]
 * ****************************************************
 *
 * 将 binlog event 追加到message
