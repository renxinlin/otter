...
public class PipelineParameter implements Serializable {
    ...
    @Transient
    private String                systemMarkTable;                                          // 双向同步标记表  retl_mark
    @Transient
    private String                systemMarkTableColumn;                                    // 双向同步标记的列名  channel_id
    @Transient
    private String                systemMarkTableInfo;                                      // 双向同步标记的info信息，比如类似BI_SYNC  channel_info
    @Transient
    private String                systemBufferTable;                                        // otter同步buffer表 retl_buffer
    @Transient
    private String                systemDualTable;                                          // otter同步心跳表
    @Transient
    private RetrieverType         retriever;                                                // 下载方式 xdual
